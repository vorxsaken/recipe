...
export default function Footer() {
  return (
    <footer className='w-full p-6 absolute bottom-0 flex flex-col gap-6 justify-center items-center border-t-2 border-slate-200'>
        <Image src={Logo} alt="Logo" width={100} />
        <p className='w-1/4 text-center text-xs'>
